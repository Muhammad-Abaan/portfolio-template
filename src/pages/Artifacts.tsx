...
import { FileText, Database, Box, Code, FileArchive, Download, X, Search, File, Loader2 } from "lucide-react";
  ...
  return (
    <main className="container py-12 md:py-24 animate-fade-in relative min-h-screen">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative flex gap-6 h-[600px] border border-white/10 rounded-2xl bg-background/30 backdrop-blur-md overflow-hidden shadow-2xl">
          
          {/* Main List Pane */}
          <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
            {/* Table Header */}
            <div className="grid grid-cols-[auto_1fr_auto_auto] gap-4 px-6 py-3 border-b border-white/5 bg-white/5 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                ...
                <div className="p-2 space-y-1">
                  {filteredArtifacts.map((artifact) => (
                    <button
                      ...
                      className={`w-full text-left grid grid-cols-[auto_1fr_auto_auto] gap-4 px-4 py-3 rounded-xl transition-all items-center ${
                    ...
                    >
                      ...
                      <div className="w-24 text-xs opacity-70 hidden sm:block">
                        {artifact.file_size || '--'}
                      </div>
                      <div className="w-32 text-xs opacity-70 hidden md:block">
...
export default function Artifacts() {
  ...
  return isMobileDevice ? <MobileArtifacts /> : <DesktopArtifacts />;
}
