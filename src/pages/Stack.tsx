...
const DesktopStack = () => {
  ...
  return (
    <motion.main 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="container py-12 md:py-24 relative"
    >
      ...
      <div className="relative max-w-4xl mx-auto pb-16" ref={containerRef}>
        <div className="absolute right-4 md:right-auto md:left-1/2 transform translate-x-1/2 md:-translate-x-1/2 top-0 bottom-16 w-1 bg-white/5 rounded-full overflow-hidden">
          <motion.div 
...
export default function Stack() {
  ...
  return isMobileDevice ? <MobileStack /> : <DesktopStack />;
}
